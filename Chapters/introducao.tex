...
Entretanto, um estudo realizado por \citeonline{Neto2015} demonstra que, de 65 artigos publicados no Brasil entre o ano de 2004 à 2014 sobre Robótica Educacional, apenas 25\% tinham como foco o ensino superior. Este resultado revela que um dos principais locais de formação de mão de obra, que são as instituições de nível superior, não estão implementando novas metodologias de ensino que vão de encontro à Indústria 4.0.
    
Deste modo, no cenário em que as espertizes e qualificações dos trabalhadores serão diretamente responsável pelo sucesso dos empreendimentos na nova indústria, as companhias e as universidades deverão buscar estratégias para o treinamento e capacitação de seus recursos humanos e que encurtem a distância entre a teoria e a prática, conforme sustentado em \cite{Benesova2017} e \cite{Gonzalez2018}.

Portanto, uma vez que a robótica e a indústria possuem componentes muito similares, diferindo principalmente em escala \cite{Khomchenko2018}, é desejável a elaboração de um projeto em que conceitos de robótica móvel, inteligência artificial, simulação e \textit{frameworks} de robótica possam ser compreendidos em processos colaborativos de capacitação ou em ambientes acadêmicos, principalmente, em cursos de engenharia.       
